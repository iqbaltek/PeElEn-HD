...
<script src="<?php echo base_url();?>assets/menu/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url();?>assets/menu/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/bootstrap-select2/select2.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/boostrap-form-wizard/js/jquery.bootstrap.wizard.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<script src="<?php echo base_url();?>assets/menu/js/form_validations.js" type="text/javascript"></script>
