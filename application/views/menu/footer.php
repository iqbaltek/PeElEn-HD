...
<!--[if lt IE 9]>
<script src="<?php echo base_url();?>assets/menu/plugins/respond.js"></script>
<![endif]-->
...
<!-- BEGIN PAGE LEVEL JS -->
<script src="<?php echo base_url();?>assets/menu/plugins/jquery-slider/jquery.sidr.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url();?>assets/menu/plugins/jquery-ricksaw-chart/js/raphael-min.js"></script>
...
<script src="<?php echo base_url();?>assets/menu/plugins/skycons/skycons.js"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/owl-carousel/owl.carousel.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/jquery-gmap/gmaps.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/Mapplic/js/jquery.easing.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/Mapplic/js/jquery.mousewheel.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/Mapplic/js/hammer.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/menu/plugins/Mapplic/mapplic/mapplic.js" type="text/javascript"></script>
